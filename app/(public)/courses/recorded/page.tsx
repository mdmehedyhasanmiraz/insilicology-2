...
export default async function AllCoursesPage() {
  try {
    ...
    if (error) {
      ...
      throw new Error(`Failed to fetch recorded courses: ${error.message}`);
    }
    ...
    return (
      <div className="max-w-6xl mx-auto px-4 py-16 text-center">
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900">রেকর্ডেড কোর্স</h1>
          <p className="text-gray-600 text-lg">কোনো রেকর্ডেড কোর্স পাওয়া যায়নি। পরে আবার চেষ্টা করুন।</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-10 md:py-16">
      ...
      <div className="text-center mb-12">
        ...
        <h1 className="text-4xl md:text-5xl font-bold text-gray-900 mb-4">রেকর্ডেড কোর্স</h1>
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8">
        {courses?.filter(course => course && course.id).map((course) => (
          <Link
            ...
            href={`/courses/${course.type?.toLowerCase() || 'recorded'}/${course.slug || course.id}`}
      ...
      <div className="text-center mt-16">
        <div className="bg-gradient-to-r from-red-50 to-pink-50 rounded-xl p-8 border border-red-100">
          ...
          <p className="text-gray-600 mb-6">আমাদের লাইভ কোর্সগুলোও দেখুন</p>
          <Link
            href="/courses/live"
    ...
    console.error('Server error in AllCoursesPage (Recorded):', error);
    return (
      <div className="max-w-6xl mx-auto px-4 py-16 text-center">
        <div className="bg-white rounded-xl shadow-lg border border-gray-200 p-8">
          <div className="w-16 h-16 bg-red-100 rounded-full flex items-center justify-center mx-auto mb-4">
          ...
          <h1 className="text-3xl md:text-4xl font-bold mb-4 text-gray-900">Error Loading Recorded Courses</h1>
          <p className="text-gray-600 text-lg">Something went wrong while loading the recorded courses. Please try again later.</p>
