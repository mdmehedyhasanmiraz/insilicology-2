...
export const metadata = {
  ...
  description: "Read the terms of services for using Insilicology's website and services.",
  keywords: ["insilicology", "terms of services", "insilicology terms of services", "insilicology terms of services page"],
  ...
  return (
    <section className="space-y-6">
      <div className="max-w-3xl mx-auto py-16 px-3 sm:px-8 space-y-4">
        ...
        <p className="">
          Welcome to Insilicology! These terms of services outline the rules and regulations for the use of {`Insilicology's`} website and services.
        </p>
        ...
        <p className="">
          All content provided on this website, including but not limited to text, images, logos, and videos, is the property of Insilicology and protected by copyright laws. You may not use, reproduce, or distribute any of our content without prior written permission.
        </p>
        ...
        <p className="">
          Insilicology will not be held liable for any damages arising from your use or inability to use the website, including but not limited to indirect, incidental, or consequential damages.
        </p>
        ...
        <p className="">
          These terms of services are governed by and construed in accordance with the laws of the jurisdiction in which Insilicology operates. Any disputes arising out of these terms will be resolved in the courts of that jurisdiction.
        </p>

        <h2 className="text-xl md:text-2xl font-semibold">10. Contact Information</h2>
        <p className="">
          If you have any questions regarding these terms of services, please contact us at <a href="mailto:insilicology@gmail.com" className="text-blue-500">insilicology@gmail.com</a>.
        </p>
