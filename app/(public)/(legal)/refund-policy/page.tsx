...
export const metadata = {
  title: "Refund Policy",
  description: "This page outlines the refund policy of Insilicology, detailing how we handle refunds and related information.",
  keywords: ["insilicology", "refund policy", "insilicology refund policy", "insilicology refund policy page"],
  ...
  return (    
    <section className="space-y-6">
      <div className="max-w-3xl mx-auto py-16 px-3 sm:px-8 space-y-4">
        ...
        <p className="">
          Insilicology (“we”, “us”, or “our”) is committed to protecting your refund. This Refund Policy explains how we collect, use, and safeguard your information when you visit our website https://insilicology.org and engage with our services. Please read this policy carefully to understand our practices.
        </p>
