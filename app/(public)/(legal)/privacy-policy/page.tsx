...
export const metadata = {
  ...
  description: "This page outlines the privacy practices of Insilicology, detailing how we collect, use, and protect your personal information.",
  keywords: ["insilicology", "privacy policy", "insilicology privacy policy", "insilicology privacy policy page"],
  ...
  return (    
    <section className="space-y-6">
      <div className="max-w-3xl mx-auto py-16 px-3 sm:px-8 space-y-4">
        ...
        <p className="">
          Insilicology (“we”, “us”, or “our”) is committed to protecting your privacy. This Privacy Policy explains how we collect, use, and safeguard your information when you visit our website https://insilicology.org and engage with our services. Please read this policy carefully to understand our practices.
        </p>

        <h2 className="text-xl md:text-2xl font-semibold">1. Who We Are</h2>
        <p className="">
          Our website address is: <a href="https://insilicology.org" className="text-blue-500">https://insilicology.org</a>.
        </p>
