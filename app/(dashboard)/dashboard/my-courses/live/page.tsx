  ...
  if (loading) {
    return (
      <div className="max-w-7xl mx-auto">
        <h1 className="text-2xl md:text-3xl font-bold mb-6 text-gray-900">আমার লাইভ কোর্সসমূহ</h1>
      ...
      {courses.length === 0 ? (
        <div className="text-center py-12">
          <div className="max-w-md mx-auto">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mb-2">কোনো লাইভ কোর্স নেই</h3>
            <p className="text-gray-600 mb-6">আপনি এখনও কোনো লাইভ কোর্সে এনরোল করেননি।</p>
            <Link
              href="/courses/live"
            ...
            >
              <div className="relative aspect-video overflow-hidden">
                ...
                <div className="absolute top-2 left-2 flex gap-2 z-20">
                  <span className="text-xs px-2 py-1 rounded-full font-semibold shadow-sm border border-white/30 backdrop-blur-sm bg-gradient-to-r from-red-500 to-pink-500 text-white">
              ...
              <div className="p-2 md:p-3 flex flex-col flex-1">
                ...
                <div className="mt-auto">
                  <span className="inline-flex justify-center align-middle items-center gap-1 px-3 py-1.5 bg-red-50 text-red-700 font-semibold text-xs rounded-full group-hover:bg-red-100 transition">
                    কোর্স দেখুন
